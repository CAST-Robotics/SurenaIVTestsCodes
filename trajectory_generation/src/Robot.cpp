...
Robot::Robot()
{
    ...
    //address += "/home/cast/humanoid/surena4/src/trajectory_generation/src/test.txt";
    address += "/home/cast/SurenaProject/Code/SurenaIV/SurenaIVDCMTest_ws/src/trajectory_generation/src/test.txt";
