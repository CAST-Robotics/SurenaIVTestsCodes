...
//}
      ...
      double dh=move2pose(.1,time_r,t_r(1),t_r(2))-move2pose(.1,time_r,t_r(3),t_r(4));
      double l=.36+.37-dh;
    ...
    q_motor_r[0]=-int(10*(qr1[count]-q0_r(0))*180/M_PI*120/60)*0+qra_offset[0];
    q_motor_r[1]=int(10*(qr2[count]-q0_r(1))*180/M_PI*120/60)*0+qra_offset[1];
    q_motor_r[2]=-int(7*(qr3[count]-q0_r(2))*180/M_PI*100/60)*0+qra_offset[2];
    q_motor_r[3]=int(7*(qr4[count]-q0_r(3))*180/M_PI*100/60)*0+qra_offset[3];
    q_motor_r[4]=int((qr5[count]-q0_r(4))*(2048)/M_PI)*0;
    q_motor_r[5]=int((qr6[count]-q0_r(5))*(4000-2050)/(23*M_PI/180))*0;
    q_motor_r[6]=int((qr7[count]-q0_r(6))*(4000-2050)/(23*M_PI/180))*0;
    ...
    q_motor_l[0]=int(10*(qr1[count]-q0_r(0))*180/M_PI*120/60)*0+qla_offset[0];
    q_motor_l[1]=-int(10*(qr2[count]-q0_r(1))*180/M_PI*120/60)*0+qla_offset[1];
    q_motor_l[2]=int(7*(qr3[count]-q0_r(2))*180/M_PI*100/60)*0+qla_offset[2];
    q_motor_l[3]=-int(7*(qr4[count]-q0_r(3))*180/M_PI*100/60)*0+qla_offset[3];

    q_motor_l[4]=-int((qr5[count]-q0_r(4))*(2048)/M_PI)*0;
    q_motor_l[5]=int((qr6[count]-q0_r(5))*(4000-2050)/(23*M_PI/180))*0;
    q_motor_l[6]=int((qr7[count]-q0_r(6))*(4000-2050)/(23*M_PI/180))*0;
    ...
    for(int  i = 0;i < 12;i++)
    {
        msg.data.push_back( qref[i]*0+qc_offset[i]);
    }
    //right hand epose
    ...
    msg.data.push_back(0);//head pitch 30
    msg.data.push_back(0);//head roll 31
    msg.data.push_back(0);//head yaw 32
