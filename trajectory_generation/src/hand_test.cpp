...
//right hand epose
msg.data.push_back(q[0]+qc_offset[12]);//12 -y  a,z
msg.data.push_back(q[1]+qc_offset[13]);//13 +x
msg.data.push_back(q[2]+qc_offset[14]);//14 -z
//msg.data.push_back(q[3]);//15 +y
msg.data.push_back(q[3]+qc_offset[15]);

//right hand dynamixel + fingers
msg.data.push_back(0);//16
msg.data.push_back(0);//17
msg.data.push_back(0);//18
msg.data.push_back(9);//19
//left hand epose
msg.data.push_back(q[4]+qc_offset[20]);//20 +y
msg.data.push_back(q[5]+qc_offset[21]);//21 +x
msg.data.push_back(q[6]+qc_offset[22]);//22 -z
msg.data.push_back(q[7]+qc_offset[23]);//23 -y
//left hand dynamixel + fingers
msg.data.push_back(0);//24
msg.data.push_back(0);//25
msg.data.push_back(0);//26
msg.data.push_back(9);//27
